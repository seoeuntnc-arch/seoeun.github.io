            ...
            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
                ...
                <li>
                    <Hyperlink
                        ...
                        text={__('For more information, please see our %stroubleshooting article%s.', 'updraftplus')}
                    />
                </li>
                <li>
                    {onboardingData.is_pro ? (
                        <>
                            <Hyperlink
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                text={__('If you are still having issues, please %scontact support%s.', 'updraftplus')}
                            />
                        </>
                    ) : (
                        <>
                            <Hyperlink
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                text={__('If you are still having issues, please %sopen a ticket%s on the WordPress.org support forum.', 'updraftplus')}
                            />
                        </>
                    )}
                </li>
